...
title <- tags$div(
  tag.map.title, HTML("<img src = streetsblog-chicago.png><p class = 'title'>Lower E-Scooter Ridership in the <strong class = 'red'>Equity Priority Area</strong></p><p>Rides from May to December 2022<br><span>Select a neighborhood</span> to view the number of rides</p>")
)   
...
map <- leaflet(scooter_communityarea, options = leafletOptions(zoomControl = FALSE)) %>% 
  ...
  addPolygons(opacity = 0.9,
              ...
              highlightOptions = highlightOptions(color = "green", weight = 1, bringToFront = T)) %>% 
